<template>
    <view class="root">
        <view class="search-bar flex-y-center">
            ...
            <view class="button search" @tap="search">搜索</view>
        </view>
        <view class="result">
            <view v-if="alreadySearched && !userList.length" class="none">找不到此用户</view>
            <view class="user-list">
                <view class="item flex-y-center" v-for="(item, index) in userList" :key="item.userId" @tap="selectUser(item)">
                    <view class="avatar">
